...
#include "Seldon-5.0.1/computation/solver/iterative/Iterative.cxx"
...
//make aditional data for:  Ax=b   
   ...
   lambda.Reallocate(n+m); lambda.Fill(0.0);
...
// by default, this parameter is equal to 10
   ...
   MinRes(A, lambda, b, precond, iter);
